...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		 ...
		 * previous, first or last contact.
	 ...
	 *  * `contact` - Total number of contact
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of contact of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} contact` The number of contact in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, contact ) {
